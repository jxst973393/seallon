...
$(function(){
	$('#down-menu , .down-menu').mouseenter(function(){
		$('.down-menu').stop(true,false).slideDown(500);
	}).mouseleave(function(){
		$('.down-menu').stop(true,false).slideUp(1300);
	});
...
//changeW('.row4');
//changeW('.row5');
//function changeW(obj){
//	var labelw = $(obj).find('label').width();
//	var roww = $(obj).width();
//	$(obj).find('input').width( roww - labelw - 14 );
//
//}
...
//service
function servicePT() {
		var imgH = $('.service .b-img img').height()/2;
		var simgPT = $('.s-img').css('padding-top',imgH);
...
$(function(){
  function firstword(){
      if(document.getElementById("word")){
       	    var words = $('#word').text();
            var regarry = words.match(/\w+\b/gi);
            var fw = regarry[0];
            var words = words.replace(fw,'<span style="color: #122a88;">' + fw + '</span>');
            $('#word').html(words);  
         }
